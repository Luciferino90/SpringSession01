...
public class UserTest extends BaseTest {
    ...
    public void testDefaultPage(){
        ...
        ResponseEntity<RestPageImpl<UserResponseDto>> response = restTemplate.exchange(getUrl("/mongo/search/user"), HttpMethod.POST, new HttpEntity(searchCriteriaRequestDto), type);
    ...
    public void testPageSmall(){
        ...
        ResponseEntity<RestPageImpl<UserResponseDto>> response = restTemplate.exchange(getUrl("/mongo/search/user?page="+pageNumber+"&size="+size), HttpMethod.POST, new HttpEntity(searchCriteriaRequestDto), type);
        RestPageImpl<UserResponseDto> page = response.getBody();
